...
<div class="form-container">
    <h2>Това е калкулатор за четирискатен покрив</h2>
    ...
    <div class="info-container">
        <ul>
            ...
            <li><span class="info-highlight">C</span> е дължината на билото на покрива</li>
            <li>За десетични размери използвайте точка за разделител! (.)</li>
        </ul>
    </div>

    <h3 class="form-title">Въведете размерите на вашия покрив:</h3>
    <form id="roof-dimensions-form"  action="javascript:void(0);" >
        ...
        <div class="input-group">
            <label for="height">C</label>
            <input type="number" id="ridge" name="ridge" placeholder="3">
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo JRoute::_('index.php?option=com_calculator&task=hiproofcalculator.calculate'); ?>', {
            method: 'POST',
            body: formData,
            headers: {
