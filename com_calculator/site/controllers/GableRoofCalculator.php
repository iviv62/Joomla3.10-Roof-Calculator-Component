...
require_once JPATH_COMPONENT . '/helpers/GableRoofCalculator.php';

class CalculatorControllerGableRoofCalculator extends JControllerLegacy
{
    public function calculate()
    {
        ...
        try {
            ...
            $calculator = new GableRoofCalculator($sides);
